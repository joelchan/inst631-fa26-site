...
### Week 7 · Tue Oct 20 · What is evaluation, and what is it for?

→ **[The full quests for this week](quests/week-07.md)**
...
!!! abstract "Before class"
    ...
    **Deadline (by class time): [Evaluations and Usability Testing Mission](missions/evaluations-and-usability-testing.md), expert review prep**


### Week 8 · Tue Oct 27 · Evaluating without users — heuristics and inspection

→ **[The full quests for this week](quests/week-08.md)**
...
!!! abstract "Before class"
    ...
    🃏 **PLAY** — heuristic complaining and your Golden Rule: can the rules describe what you hate, and if not, write your own

    Weekly reflection

    **Deadline (by class time): [Evaluations and Usability Testing Mission](missions/evaluations-and-usability-testing.md), expert review**


### Week 9 · Tue Nov 3 · Evaluating with users — usability testing

→ **[The full quests for this week](quests/week-09.md)**
...
### Week 11 · Tue Nov 17 · Evaluating for accessibility

→ **[The full quests for this week](quests/week-11.md)**
...
!!! abstract "Before class"
    ...
    🔧 **SETUP** — get a working AI build tool sorted (Websim, Claude Artifacts, v0, Bolt — it just has to give you a link someone else can open). Bring it Tuesday whether or not it works; we finish the job in the room
...
→ **[The full quests for this week](quests/week-13.md)**
...
!!! abstract "Before class"
    ...
    **Deadline (by class time): [Accessibility Testing Mission](missions/accessibility-testing.md), automated inspection**


### Week 14 · Tue Dec 8 · Wrap up — potluck!

→ **[The full quests for this week](quests/week-14.md)**
