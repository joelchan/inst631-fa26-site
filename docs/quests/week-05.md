...
play: true
reflection: standard
deadline: "[CHI Papers Mission](../missions/chi-papers.md) Part 3"
tags:
  - quest
  - weekly-quest
---

# Week 5 — Interfaces — conceptualizing interaction, and the forms it takes

**Tue Sep 29** · Part 1: Foundations · [Schedule](../schedule.md)

## 📚 READ

- ID 3 - Conceptualizing Interaction (31 pages)
- ID 7 - Interfaces (66 pages)

## 📺 WATCH

Pick **one** video from this playlist of interface-studies video essays: https://www.youtube.com/watch?v=vRDxelta5Pg&list=PLN2Xe3mUoVEs (on average these are 15-20 minute videos). Please note in your reflection which one you picked!

## 🃏 PLAY

**Exploring interaction.**

Pick a design objects you use/hate/see and brainstorm/sketch **at least 3** radically different interfaces/interactions into the object, drawing on interface ideas and designs from the read and watch materials. Note down for yourself what you noticed about what was easy and what was hard about this.

As before: set a timer for **1 hour** and submit what you have when the timer goes off. Mess and in-progress thinking encouraged.

**Optional additional interface inspiration:**

- https://x.com/poetengineer__?lang=en
