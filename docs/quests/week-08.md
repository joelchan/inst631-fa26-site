...
part: 2
partname: Evaluation
topic: Evaluating without users
format: in-person
read: true
watch: true
play: true
reflection: standard
deadline: "[Evaluations and Usability Testing Mission](../missions/evaluations-and-usability-testing.md) Part 2"
tags:
  - quest
  - weekly-quest
---

# Week 8 — Evaluating without users — heuristics and inspection

**Tue Oct 27** · Part 2: Evaluation · [Schedule](../schedule.md)

## 📚 READ

ID 16 - Evaluation - Inspections, Analytics, and Models

## 📺 WATCH

Nielsen's usability heuristics, ~40 min total:

- [3-min intro](https://youtu.be/6Bw0n6Jvwxk)
- all ten short videos (~30 min), starting at [#1](https://youtu.be/cTtc90jCULU) — you have to click through to #2 … #10 at the end of each
- [*Why I never used Jakob Nielsen's 10 Usability Heuristics*](https://youtu.be/be5i-ofRy80) (6 min)

## 🃏 PLAY

**Heuristic complaining and your Golden Rule.**

Return to one of the designs you complained about in prior weeks (or come up with a new one!), and compare it against the "rules" and heuristics you've encountered last week and in this week's read/watch. Can your hate for the design be described usefully by any of these rules/heuristics? If so, describe it! If not, make up your own Golden Rules of Design to make sure no one else commits the same design sins again!
