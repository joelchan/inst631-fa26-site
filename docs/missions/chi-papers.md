...
- To find CHI papers, go dig through the proceedings available [here](https://dl.acm.org/conference/chi/proceedings). Start in **2026** — that's where you'll find your topic. You may have to be logged in via campus wifi or through the UMD library to get your free access.
...
- Put / link to a snapshot of the map in the Google Doc section for Part 3
